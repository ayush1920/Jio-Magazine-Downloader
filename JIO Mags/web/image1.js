function resetid(){
		document.getElementById("page1").className ="trash";
		document.getElementById("page3").className ="trash";
		document.getElementById("page22").className ="trash";
		document.getElementById("page4").className ="trash";
		document.getElementById("page8").className ="trash";
		document.getElementById("page12").className ="trash";
		document.getElementById("page13").className ="trash";
}
...
async function forfunction(page){
	...
	let value= await eel.getPageData(page.toString(),"2")();
...
function showImage2(magId,issueId){
	...
	img.onclick =async function(){
		...
		ifrm.setAttribute("src","../downloads/"+img_magid+"/"+img_issueId+".pdf#page=1&zoom=100");
